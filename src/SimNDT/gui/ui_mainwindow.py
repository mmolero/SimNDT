...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuNew_Simulation_Scenario = QtWidgets.QMenu(self.menuConfiguration)
        icon = QtGui.QIcon()
        ...
        self.menuAdd_Microstructure = QtWidgets.QMenu(self.menuNew_Simulation_Scenario)
        self.menuAdd_Microstructure.setObjectName("menuAdd_Microstructure")
        self.menuInspection_Setup = QtWidgets.QMenu(self.menuConfiguration)
        self.menuInspection_Setup.setObjectName("menuInspection_Setup")
        self.menuPlotting_Tools = QtWidgets.QMenu(self.menubar)
        self.menuPlotting_Tools.setObjectName("menuPlotting_Tools")
        self.menuSingle_Launch_Inspections = QtWidgets.QMenu(self.menuPlotting_Tools)
        icon1 = QtGui.QIcon()
        ...
        self.menuLinear_Scan_Inspections = QtWidgets.QMenu(self.menuPlotting_Tools)
        icon2 = QtGui.QIcon()
        ...
        self.menuTomography_Inspections = QtWidgets.QMenu(self.menuPlotting_Tools)
        icon3 = QtGui.QIcon()
        ...
        self.actionMaterials_Setup = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        ...
        self.actionBoundaty_Conditions_Setup = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        ...
        self.actionSimulation_Setup = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        ...
        self.actionCreate_Video_from_Images = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        ...
        self.actionLoad_Scenario_From_Image = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        ...
        self.actionPreview_Labeled_Scenario = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        ...
        self.actionSingle_Launch_Inspection = QtWidgets.QAction(MainWindow)
        ...
        self.actionLinear_Scan_Inspections = QtWidgets.QAction(MainWindow)
        ...
        self.actionTomography_Inspections = QtWidgets.QAction(MainWindow)
        ...
        self.actionRotate_The_Scenario_90_Clockwise = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        ...
        self.actionRotate_The_Scenario_90_Counter_Clockwise = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        ...
        self.actionCheck_Simulation_Setup = QtWidgets.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        ...
        self.actionPlot_Receiver_Signals_SingleLaunch = QtWidgets.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        ...
        self.actionPlot_Receiver_Signals_Spectra = QtWidgets.QAction(MainWindow)
        icon17 = QtGui.QIcon()
        ...
        self.actionPlot_Receivers_Signals_LinearScan = QtWidgets.QAction(MainWindow)
        ...
        self.actionPlot_Receivers_Signals_Tomography = QtWidgets.QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "SimNDT"))
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.menuConfiguration.setTitle(_translate("MainWindow", "Configuration"))
        self.menuNew_Simulation_Scenario.setToolTip(_translate("MainWindow", "New Scenario"))
        self.menuNew_Simulation_Scenario.setStatusTip(_translate("MainWindow", "New Scenario"))
        self.menuNew_Simulation_Scenario.setTitle(_translate("MainWindow", "New Simulation Scenario"))
        self.menuAdd_Microstructure.setTitle(_translate("MainWindow", "Add Concrete Microstructure Model"))
        self.menuInspection_Setup.setTitle(_translate("MainWindow", "Inspection Setup"))
        self.menuPlotting_Tools.setTitle(_translate("MainWindow", "Plotting Tools"))
        self.menuSingle_Launch_Inspections.setTitle(_translate("MainWindow", "Single Launch Inspections"))
        self.menuLinear_Scan_Inspections.setTitle(_translate("MainWindow", "Linear Scan Inspections"))
        self.menuTomography_Inspections.setTitle(_translate("MainWindow", "Tomography Inspections"))
        self.menuTools.setTitle(_translate("MainWindow", "Tools"))
        self.actionMaterials_Setup.setText(_translate("MainWindow", "Materials Setup"))
        self.actionMaterials_Setup.setStatusTip(_translate("MainWindow", "Materials Setup"))
        self.actionBoundaty_Conditions_Setup.setText(_translate("MainWindow", "Boundary Conditions Setup"))
        self.actionBoundaty_Conditions_Setup.setStatusTip(_translate("MainWindow", "Boundary Conditions Setup"))
        self.actionSimulation_Setup.setText(_translate("MainWindow", "Simulation Setup"))
        self.actionRun_Simulation.setText(_translate("MainWindow", "Run Simulation"))
        self.actionRun_Simulation.setStatusTip(_translate("MainWindow", "Run_Simulation"))
        self.actionRun_Simulation.setShortcut(_translate("MainWindow", "Meta+Alt+R"))
        self.actionCreate_Video_from_Images.setText(_translate("MainWindow", "Create Video from Images"))
        self.actionCreate_Video_from_Images.setStatusTip(_translate("MainWindow", "Create Video from Images"))
        self.actionNew_Geometry_Model.setText(_translate("MainWindow", "New Geometry Model"))
        self.actionNew_Geometry_Model.setShortcut(_translate("MainWindow", "Meta+Alt+N"))
        self.actionAdd_Ellipse.setText(_translate("MainWindow", "Add Ellipse"))
        self.actionAdd_Ellipse.setStatusTip(_translate("MainWindow", "Add Ellipse"))
        self.actionAdd_Ellipse.setShortcut(_translate("MainWindow", "Meta+Alt+E"))
        self.actionAdd_Rectangle.setText(_translate("MainWindow", "Add Rectangle"))
        self.actionAdd_Rectangle.setStatusTip(_translate("MainWindow", "Add Rectangle"))
        self.actionAdd_Rectangle.setShortcut(_translate("MainWindow", "Meta+Alt+R"))
        self.actionLoad_Scenario_From_Image.setText(_translate("MainWindow", "Load Scenario From Image"))
        self.actionLoad_Scenario_From_Image.setStatusTip(_translate("MainWindow", "Load Scenario From Image"))
        self.actionLoad_Scenario_From_Image.setShortcut(_translate("MainWindow", "Meta+Alt+I"))
        self.actionPreview_Labeled_Scenario.setText(_translate("MainWindow", "Preview Labeled Scenario"))
        self.actionPreview_Labeled_Scenario.setStatusTip(_translate("MainWindow", "Preview Labeled Scenario"))
        self.actionPreview_Labeled_Scenario.setShortcut(_translate("MainWindow", "Meta+Alt+P"))
        self.actionSingle_Launch_Inspection.setText(_translate("MainWindow", "Single Launch Inspection"))
        self.actionSingle_Launch_Inspection.setStatusTip(_translate("MainWindow", "Single Launch Inspection"))
        self.actionLinear_Scan_Inspections.setText(_translate("MainWindow", "Linear Scan Inspections"))
        self.actionTomography_Inspections.setText(_translate("MainWindow", "Tomography Inspections"))
        self.actionRotate_The_Scenario_90_Clockwise.setText(_translate("MainWindow", "Rotate The Scenario 90º Clockwise"))
        self.actionRotate_The_Scenario_90_Clockwise.setToolTip(_translate("MainWindow", "Rotate The Scenario 90º Clockwise"))
        self.actionRotate_The_Scenario_90_Counter_Clockwise.setText(_translate("MainWindow", "Rotate The Scenario 90º Counter Clockwise"))
        self.actionRotate_The_Scenario_90_Counter_Clockwise.setToolTip(_translate("MainWindow", "Rotate The Scenario 90º Counter Clockwise"))
        self.actionCheck_Simulation_Setup.setText(_translate("MainWindow", "Check Simulation Setup"))
        self.actionPlot_Receiver_Signals_SingleLaunch.setText(_translate("MainWindow", "Plot Receiver Signals"))
        self.actionPlot_Receiver_Signals_Spectra.setText(_translate("MainWindow", "Plot Receiver Spectra"))
        self.actionPlot_Receivers_Signals_LinearScan.setText(_translate("MainWindow", "Plot Receivers Signals"))
        self.actionPlot_Receivers_Signals_Tomography.setText(_translate("MainWindow", "Plot Receivers Signals"))
        self.actionAdd_Two_Phase_Concrete_Microstructure.setText(_translate("MainWindow", "Add Two-Phase Concrete Microstructure"))
        self.actionAdd_Three_Phase_Concrete_Microstructure.setText(_translate("MainWindow", "Add Three-Phase Concrete Microstructure"))
        self.actionTwo_Phase_Model_Dry_Case.setText(_translate("MainWindow", "Two-Phase Model (Dry Case)"))
        self.actionThree_Phase_Model_Dry_Case.setText(_translate("MainWindow", "Three-Phase Model (Dry Case)"))
        self.actionTwo_Phase_Model_Immersion_Case.setText(_translate("MainWindow", "Two-Phase Model (Immersion Case)"))
        self.actionThree_Phase_Model_Immersion_Case.setText(_translate("MainWindow", "Three-Phase Model (Immersion Case)"))
